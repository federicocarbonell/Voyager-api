...
namespace VoyageAPI.Logic
{
    public class ReportLogic : IReportLogic
    {
        ...
        public ReportDTO AddReport(int productId, Report report)
        {
            ...
            if (report.VisitDate == null) throw new ArgumentException("The report must contain a visite date.");
            //else
            //{
            //    if (report.VisitDate > DateTime.Now) throw new ArgumentException("The visit date cannot be greater than today.");
            //}
            if (report.TimeArrival == null) throw new ArgumentException("The report must contain the arrival time.");
            if (report.TimeResolution == null) throw new ArgumentException("The report must contain the resolution time.");
